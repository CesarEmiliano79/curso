...
import { addRegistration } from '../utilities/firebase.jsx'
...
export default function Registration() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const registrationId = await addRegistration(form)
      navigate('/registration/confirmation', { state: { form, registrationId } })
    } catch (err) {
      const message = err instanceof Error && err.message.startsWith('Invalid registration data')
        ? err.message.replace('Invalid registration data: ', '')
